...
namespace ZoneTop.Application.SSO.Common.Model
{
    ...
    /// 日志格式器
    /// </summary>
    public static class LogFormatModel
    {
        /// <summary>
        /// 生成错误
        /// </summary>
        ...
        /// <returns></returns>
        public static string ErrorFormat(LogMessageModel logMessage)
        {
        ...
        /// <param name="logMessage">对象</param>
        /// <returns></returns>
        public static string WarnFormat(LogMessageModel logMessage)
        {
            StringBuilder strInfo = new StringBuilder();
        ...
        /// <param name="logMessage">对象</param>
        /// <returns></returns>
        public static string InfoFormat(LogMessageModel logMessage)
        {
            StringBuilder strInfo = new StringBuilder();
        ...
        /// <param name="logMessage">对象</param>
        /// <returns></returns>
        public static string DebugFormat(LogMessageModel logMessage)
        {
            StringBuilder strInfo = new StringBuilder();
        ...
        /// <param name="logMessage">对象</param>
        /// <returns></returns>
        public static string ExceptionFormat(LogMessageModel logMessage)
        {
            StringBuilder strInfo = new StringBuilder();
            strInfo.Append("1. 调试: >> 操作时间: " + logMessage.OperationTime + "   操作人: " + logMessage.UserName + " \r\n");
            strInfo.Append("2. 地址: " + logMessage.Url + "    \r\n");
